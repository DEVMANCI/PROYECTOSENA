...
$sql = $con->prepare("SELECT id, nombre, descripcion, precio, descuento, stock, id_categoria FROM mujer WHERE id = ? AND activo = 1");
$sql->execute([$id]);
$mujer = $sql->fetch(PDO::FETCH_ASSOC);

$sql = "SELECT id, nombre FROM categorias WHERE activo = 1";
$resultado = $con->query($sql);
$categorias = $resultado->fetchAll(PDO::FETCH_ASSOC);

$rutaImagenes = '../../images/mujer/' . $id . '/';
...
<main>
    <div class="container-fluid px-4">
        <h2 class="mt-3">Modifica mujer</h2>
        <form action="actualiza.php" method="post" enctype="multipart/form-data" autocomplete="off">
            <input type="hidden" name="id" value="<?php echo $mujer['id']; ?>" />
            <div class=" mb-3">
                <label for="nombre" class="form-label">Nombre:</label>
                <input type="text" class="form-control" name="nombre" id="nombre"
                    value="<?php echo htmlspecialchars($mujer['nombre'], ENT_QUOTES); ?>" required autofocus />
            </div>
            <div class="col mb-3">
                <label for="descripcion" class="form-label">Descripción:</label>
                <textarea type="text" class="form-control" name="descripcion" id="editor"
                    required><?php echo $mujer['descripcion']; ?></textarea>
            </div>
            <div class="row mb-2">
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="number" class="form-control" name="precio" value="<?php echo $mujer['precio']; ?>"
                        id="precio" aria-describedby="helpId" required />
                </div>
                <div class="col mb-3">
                    <label for="descuento" class="form-label">Descuento:</label>
                    <input type="text" class="form-control" name="descuento"
                        value="<?php echo $mujer['descuento']; ?>" id="descuento" aria-describedby="helpId"
                        required />
                </div>
                <div class="col mb-3">
                    <label for="stock" class="form-label">Stock:</label>
                    <input type="text" class="form-control" name="stock" id="stock"
                        value="<?php echo $mujer['stock']; ?>" aria-describedby="helpId" required />
                </div>
            </div>
            <div class="row">
                <div class="col-4 mb-3">
                    ...
                    <select class="form-select" name="categoria" id="categoria" required>
                        ...
                        <option value="<?php echo $categoria['id']; ?>" <?php if ($categoria['id'] == $mujer['id_categoria'])
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select class="form-select" name="talla[]">
                            ...
                            <option value="<?php echo $talla['id']; ?>" <?php if ($talla['id'] == $mujer['nombre'])
                    ...
                    <div class="col">
                        ...
                        <select class="form-select" name="color[]">
                            ...
                            <option value="<?php echo $color['id']; ?>" <?php if ($color['id'] == $mujer['nombre'])

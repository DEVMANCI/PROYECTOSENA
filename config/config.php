...
/** URL de la tienda */
define("BASE_URL", "http://localhost/proyectosena/lovemestore-main/lovemestore-main/admin/inicio.php");
...
$num_cart = 0;
if (isset($_SESSION['carrito']['mujer'])) {
    $num_cart = count($_SESSION['carrito']['mujer']);
}